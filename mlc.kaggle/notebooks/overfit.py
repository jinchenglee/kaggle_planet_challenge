...
datasets_path = data_helper.get_jpeg_data_files_paths(overfit=True)
...
train_jpeg_dir, test_jpeg_dir, train_csv_file, test_csv_file = data_helper.get_jpeg_data_files_paths(overfit=True)
...
#if os.path.isfile('weights/' + MYNET + 'weights.overfit.hdf5'):
#    mynet.model.load_weights("weights/" + MYNET + "weights.overfit.hdf5")
...
callbacks = [train_history,
             ...
             ModelCheckpoint(filepath='weights/' + MYNET + '.weights.overfit.hdf5', verbose=1, save_best_only=True,
...
train_history = mynet.model.fit_generator(train_generator, train_steps, epochs=50, verbose=1,
...
#plt.show()
plt.savefig(MYNET+".losses.overfit.png")

# Loading trained weights
mynet.model.load_weights("weights/" + MYNET + ".weights.overfit.hdf5")
print("Weights loaded")
mynet.model.save("models/"+ MYNET + ".overfit.hdf5")
